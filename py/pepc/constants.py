...
aminoAcidMasses['X'] = aminoAcidMasses['L']  # X = L or I
aminoAcidMasses['B'] = (aminoAcidMasses['N'] + aminoAcidMasses['D']) / 2.0  # B = average [N, D]
aminoAcidMasses['Z'] = (aminoAcidMasses['Q'] + aminoAcidMasses['E']) / 2.0  # Z = average [Q, E]
